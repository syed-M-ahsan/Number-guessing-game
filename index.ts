...
if (answer.userGuessNumber == randomNumber) {
  ...
  console.log(
    `your answer "${answer.userGuessNumber}" is equal to "${randomNumber}"`
  );
} else {
  console.log(
    `please try again ! your answer is incorrect ${answer.userGuessNumber} is not equal to ${randomNumber}`
  );
}
